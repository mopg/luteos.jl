...
function basisFuncLineLag( ::Type{Val{2}}, s::Array{Float64} )
...
function basisFuncLineLag( ::Type{Val{3}}, s::Array{Float64} )
...
function basisFuncLineLag( ::Type{Val{4}}, s::Array{Float64} )
...
function basisFuncLineLag( ::Type{Val{5}}, s::Array{Float64} )
